...
<div id="main-content">
  ...
  <a class="navbar-brand" href="template.html">Template</a>
...
<main role="main" class="container-template">
  <div class="jumbotron">
    <div class="row">
      <div class="col-md-4 product-grid">
        <div class="image">
          <a href="#">
            <img src="camera.png" class="w-100">
            <div class="overlay">
              <div class="detail">
                Vedi Dettagli
              </div>
      ...
      <div class="col-md-4 product-grid">
        ...
        <h5>Prezzo: $XXXX</h5>
        <a href="#">
            <button type="button" class="btn btn-warning">Dettagli</button>
        </a>
